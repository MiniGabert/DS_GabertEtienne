...
namespace DS_GabertEtienne.Controllers
{
    public class OrganisationsController : Controller
    {
        ...
        public OrganisationsController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Organisation organisation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Organisation organisation)
        {
