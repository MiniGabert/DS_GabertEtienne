...
namespace DS_GabertEtienne.Controllers
{
    public class PersonnesController : Controller
    {
        ...
        public PersonnesController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Prenom,Nom,Pseudo,Email,DatNaissance,Sexe,Photo")] Personne personne)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Prenom,Nom,Pseudo,Email,DatNaissance,Sexe,Photo")] Personne personne)
        {
            if (id != personne.Id)
            {
                return NotFound();
