...
namespace DS_GabertEtienne.Controllers
{
    public class ParticipantsController : Controller
    {
        ...
        public ParticipantsController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Equipe")] Participant participant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Equipe")] Participant participant)
        {
